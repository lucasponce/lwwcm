...
<div class="lwwcm-relationships" >
    <ul>
        ...
        %>
        <li>
            <div class="lwwcm-relationship-newtitle left margin-top"><span class="glyphicon glyphicon-file margin-right margin-top"></span> <%= p.getTitle() %> <span class="glyphicon glyphicon-globe margin-left-locale margin-top"></span> <%= p.getLocale() %></div>
            ...
            <div class="lwwcm-relationship-input left margin-left">
                <input id="<%= n %>inputNewKey<%= p.getId() %>" class="lwwcm-input margin-left-cat" />
            </div>
...
<div class="lwwcm-relationships-selected" >
    ...
    <ul>
        <%
         ...
         %>
        <li>
            <div class="lwwcm-relationship-origin left margin-top left"><span class="glyphicon glyphicon-file margin-right margin-top"></span> <%= post.getTitle() %> <span class="glyphicon glyphicon-globe margin-left-locale margin-top"></span> <%= post.getLocale() %></div>
            <div class="lwwcm-relationship-newkey left margin-top margin-left">
            ...
            <div class="lwwcm-relationship-newtitle left margin-top left"><span class="glyphicon glyphicon-file margin-right margin-top"></span> <%= pr.getTitle() %> <span class="glyphicon glyphicon-globe margin-left-locale margin-top"></span> <%= pr.getLocale() %></div>
            <div class="clear"></div>
        </li>
        <%
                }
