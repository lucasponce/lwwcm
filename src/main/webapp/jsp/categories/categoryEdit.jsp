...
<div class="container">
    ...
    <form id="${n}editCategoryForm" method="post" action="${editCategoryAction}">
        ...
        <div class="lwwcm-newcategory">
                ...
                <div class="lwwcm-newcategory-name"><input id="${n}newCategoryName" name="newCategoryName" class="lwwcm-input margin-left-cat" value="<%= c.getName() %>" onchange="setCategoryModified()" /></div>
                <span class="glyphicon glyphicon-tag margin-right margin-top"></span>
                <label for="${n}newCategoryType">Category type: </label>
                <div class="lwwcm-newcategory-type"><select id="${n}newCategoryType" name="newCategoryType" class="lwwcm-input" onchange="setCategoryModified()">
        ...
        <div class="<%= cssClass %>" id="${n}editCategoryParentContainer">
            ...
            <div class="lwwcm-newcategory-type">
                <select id="${n}newCategoryParent" name="newCategoryParent" class="lwwcm-input" onchange="setCategoryModified()">
